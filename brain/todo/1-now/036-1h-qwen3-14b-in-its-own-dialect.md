# T-036 — Qwen3-14B through the agent probe in its own dialect

**Effort:** 1 h, mostly waiting · **Produces:** the last cell of the
dialect A/B, and whether `Qwen3-14B`'s PARTIAL was ours · **Area:**
`--tool-template native`, `models.json`

Not a 16 GB answer: 9.1 GB of weights is over a stock 16 GB laptop's ~8 GB
iGPU ceiling. The 16 GB question moved to T-037.
...
The tier-2 table has a Qwen3-14B row with both dialects.
