...
| `Qwen3-14B-int4` | 9.1 GB | **works, slowly**: 7 of 8 tasks on the 140V + B60 once two of our bugs were fixed; 3-17 min a task on the iGPU, ~13 GB GPU memory -- the 16 GB answer, with the override at ~80% |
